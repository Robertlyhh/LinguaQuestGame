...
Thank you for purchasing VectoRaith's Traditional Mediterranean Buildings Tileset Pack!
...
In this pack, there are 3 main contents (A-C):
...
Based on the number in their last name, there are currently 6 types of Main Tileset:
1. Town Buildings Set A ---- Also known as Buildings Set 1. It contains Small House, Shop, Tavern, and Blacksmith building, as well as basic items needed to build a simple town. This set is non-modular.
...
4. Palace Building Set ---- Also known as Buildings Set 4. **This set is currently unavailable for this pack.**
5. Fort and Tower Building Set ---- Also known as Buildings Set 5. **This set is currently unavailable for this pack.**
...
If you want to use Tiled for auto-tiling, due to current incompatibility, of course the autotileset need to be adjusted manually
