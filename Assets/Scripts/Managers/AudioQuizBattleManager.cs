...
public class AudioQuizBattleManager : MonoBehaviour
{
    public GameObject audioQuizPanel;
    public AudioQuizManager audioQuizManager;
    ...
    public string[] battleMessages = {
        "Get ready for a audio quiz challenge!",
        "Can you solve this?",
        "Time to test your skills!",
        "Let's see what you've got!",
        "Prepare for a audio quiz showdown!"
    };
    ...
    IEnumerator StartTurn()
    {
        ...
        audioQuizPanel.SetActive(true);
        audioQuizManager.StartNewChallenge(this); // Give reference to callback to return result
    }

    public void OnPlayerSubmitted(bool success, float timeRemaining)
    {
        audioQuizPanel.SetActive(false);
