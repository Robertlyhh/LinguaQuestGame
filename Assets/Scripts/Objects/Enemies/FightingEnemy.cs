...
public class FightingEnemy : MonoBehaviour
{
    ...
    public float Speed;
    public float hittingTime = 0.6f; // Time it takes to hit the player
    ...
    public IEnumerator AttackPlayerCo()
    {
        ...
        yield return new WaitForSeconds(hittingTime); // Adjust the wait time as needed for the attack animation
        if (Animation != null)
        {
